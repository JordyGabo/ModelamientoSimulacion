...
class Pronostico:
    ...
    def promedioMovil(self, x:str, y:str, xlbl:str, ylbl:str):
        ...
        plt.grid()
        plt.plot(a[ylbl],label=ylbl,marker='o', color='brown')
        plt.plot(a['MMO_3'],label=xlbl, marker='*', color='black')
        plt.plot(a['MMO_4'],label=xlbl, marker='+', color='red')
        plt.legend(loc=2)
    ...
    def regresionLineal(self, x:str, y:str, xlbl:str, ylbl:str):
        ...
        plt.plot(x,yAjuste, color='brown')
        img = io.BytesIO()
    ...
    def regresionLinealCuadratica(self, x:str, y:str, xlbl:str, ylbl:str):
        ...
        plt.plot(x,y_ajuste, color='brown')
